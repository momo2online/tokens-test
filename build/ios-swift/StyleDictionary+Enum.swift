...
public enum StyleDictionaryEnum {
    public static let colorBaseGrayDark = UIColor(red: 0.467, green: 0.467, blue: 0.467, alpha: 1)
    public static let colorBaseGrayLight = UIColor(red: 0.000, green: 0.333, blue: 0.400, alpha: 1)
    ...
    public static let colorFontTertiary = UIColor(red: 0.000, green: 0.333, blue: 0.400, alpha: 1)
    public static let colorSkyBlue = UIColor(red: 1.000, green: 0.000, blue: 0.000, alpha: 1)

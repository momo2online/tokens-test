...
internal struct StyleDictionaryStruct {
    internal static let colorBaseGrayDark = UIColor(red: 0.333, green: 0.333, blue: 0.333, alpha: 1)
    ...
    internal static let fontColorFontBase = UIColor(red: 1.000, green: 0.000, blue: 0.000, alpha: 1)
    internal static let fontColorFontSecondary = UIColor(red: 0.000, green: 1.000, blue: 0.000, alpha: 1)
    internal static let fontColorFontTertiary = "#000000"
